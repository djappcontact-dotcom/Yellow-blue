  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child: profileView(height, width)) // This trailing comma makes auto-formatting nicer for build methods.
    );
  }
  ...
  Widget mainBlocks(height, width) {
    ...
    return Container(
        child:  Column(
            children: [
              Padding(
                padding: EdgeInsets.only(left: width * 0.03, top: height * padTop, right: width * 0.1),
    ...
    child: Column(children: [
              Container(
                ...
                padding: EdgeInsets.only(left: 15, top: sizeTopText, right: 15, bottom: 0),
                decoration: BoxDecoration(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                        ...
                        textScaleFactor: 1.0,
                        style: TextStyle(
                            fontSize: SizeConfig.heightMultiplier * sizePaddingDesc,
