...
class RatingDialog extends StatefulWidget {
  ...
  const RatingDialog({
    ...
    this.backgroundColor = const Color(0xFFF0FF52),
  });
                      ...
                      Container(
                        ...
                        decoration: ShapeDecoration(
                          shape: RoundedRectangleBorder(
                            side:
                                BorderSide(width: 1, color: Color(0xFFF9FF00)),
                        ...
                        child: Container(
                            ...
                            decoration: ShapeDecoration(
                              gradient: LinearGradient(
                                ...
                                colors: [Color(0xFF454545), Color(0xFF202020)],
                              ),
                              shape: RoundedRectangleBorder(
                  ...
                  widget.secondButton
                      ? GestureDetector(
                          ...
                          child: Container(
                              ...
                              decoration: boxDecoration(
                                  bgColor: const Color(0xff2050F6), radius: 16),
